...
import com.guymichael.reactdroid.extensions.components.list.adapter.model.BaseComponentViewHolder

class PagerComponentViewHolder(itemView: View)
    : BaseComponentViewHolder<PagerItemProps<*>>(itemView) {

    private lateinit var mComponent: AComponent<*, *, *>

    override fun bind(item: PagerItemProps<*>) {
        ...
        try {
            ...
            if (BuildConfig.DEBUG) {
                ...
                Logger.e(
                    PagerComponentViewHolder::class
    ...
    private fun getOrCreateComponent(item: PagerItemProps<*>): AComponent<*, *, *> {
