package com.guymichael.reactdroid.extensions.dialog
...
class ModalDialog { companion object {
    ...
    fun of(context: Context, @StringRes title: Int? = null, @StringRes  message: Int? = null
        ...
        return of(context, title?.let { context.getText(it) }, message?.let { context.getText(it) }
...
fun AComponent<*, *, *>.dialog(title: CharSequence? = null, message: CharSequence? = null
                               ...
                               , @StyleRes style: Int = 0): AlertDialog {

    return ModalDialog.of(mView.context!! //THINK null context
        , title, message
...
fun AComponent<*, *, *>.dialog(@StringRes title: Int? = null, @StringRes message: Int? = null
    ...
    return dialog(title?.takeIf { it != 0 }?.let(::getText)
